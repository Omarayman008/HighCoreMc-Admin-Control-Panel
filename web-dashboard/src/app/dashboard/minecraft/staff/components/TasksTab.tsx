              ...
              >
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  <button 
                    ...
                    disabled={isExpired || !currentEmpId}
                    style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', background: (isExpired || !currentEmpId) ? 'rgba(255,255,255,0.05)' : '#55bb55', color: (isExpired || !currentEmpId) ? 'var(--text-muted)' : '#fff', border: 'none', padding: '0.8rem', borderRadius: '10px', fontWeight: 600, cursor: (isExpired || !currentEmpId) ? 'not-allowed' : 'pointer', transition: 'all 0.2s' }}
                  >
