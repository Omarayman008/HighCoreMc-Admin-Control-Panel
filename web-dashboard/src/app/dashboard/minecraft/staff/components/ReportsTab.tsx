                ...
                <div style={{ width: '100%' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', paddingRight: '2.8rem' }}>
                      ...
                      <div style={{ fontSize: '0.8rem', fontWeight: 700, color: '#55bb55' }}>
                        +{report.points} PTS
                      </div>
                    </div>
                  </div>
      ...
      <AnimatePresence>
        {showAddModal && (
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(5px)', zIndex: 1000, display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '1rem' }}>
            ...
            >
              <h2 style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--foreground)', marginBottom: '1rem' }}>{editingReport ? 'Edit Minecraft Report' : 'Create Minecraft Report'}</h2>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                {reportType === 'monitoring' && (
                  <>
                    <div style={{ display: 'flex', gap: '1rem' }}>
                      <div style={{ flex: 1 }}>
                        <label style={{ display: 'block', marginBottom: '0.2rem', color: 'var(--text-muted)', fontSize: '0.8rem' }}>Start Time</label>
                        <DatePicker 
                          ...
                          customInput={<input style={{ width: '100%', padding: '0.5rem 0.6rem', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--glass-border)', borderRadius: '10px', color: 'var(--foreground)' }} />}
                        />
                      </div>
                      <div style={{ flex: 1 }}>
                        <label style={{ display: 'block', marginBottom: '0.2rem', color: 'var(--text-muted)', fontSize: '0.8rem' }}>End Time</label>
                        <DatePicker 
                    ...
                    <div style={{ display: 'flex', gap: '1rem' }}>
                      <div style={{ flex: 1 }}>
                        <label style={{ display: 'block', marginBottom: '0.2rem', color: 'var(--text-muted)', fontSize: '0.8rem' }}>Handled Violations</label>
                        <input type="number" min="0" required value={handledVio} onChange={e => setHandledVio(parseInt(e.target.value) || 0)} style={{ width: '100%', padding: '0.5rem 0.6rem', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--glass-border)', borderRadius: '10px', color: 'var(--foreground)' }} />
                      </div>
                      <div style={{ flex: 1 }}>
                        <label style={{ display: 'block', marginBottom: '0.2rem', color: 'var(--text-muted)', fontSize: '0.8rem' }}>General Violations</label>
                        <input type="number" min="0" required value={generalVio} onChange={e => setGeneralVio(parseInt(e.target.value) || 0)} style={{ width: '100%', padding: '0.5rem 0.6rem', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--glass-border)', borderRadius: '10px', color: 'var(--foreground)' }} />
                      </div>
                    </div>
                  </>
                )}
                ...
                {reportType === 'glitch' && (
                  <div>
                    ...
                    <input type="text" required value={title} onChange={e => setTitle(e.target.value)} style={{ width: '100%', padding: '0.5rem 0.6rem', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--glass-border)', borderRadius: '10px', color: 'var(--foreground)' }} placeholder="e.g. Duplication bug at spawn" />
                  </div>
                )}
                ...
                {(reportType === 'glitch' || reportType === 'special') && (
                  <div>
                    ...
                    <textarea required value={desc} onChange={e => setDesc(e.target.value)} style={{ width: '100%', padding: '0.5rem 0.6rem', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--glass-border)', borderRadius: '10px', color: 'var(--foreground)', minHeight: '100px', resize: 'vertical' }} placeholder="Provide a detailed description of your report..." />
                  </div>
                )}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', border: '1px solid var(--glass-border)', padding: '1.2rem', borderRadius: '14px', background: 'rgba(255,255,255,0.02)' }}>
                  <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-muted)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <Plus size={14} color="#55bb55" /> Evidence & Proof
                  </span>
                  
                  <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                    <div style={{ flex: 1, minWidth: '200px' }}>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.2rem', color: 'var(--text-muted)', fontSize: '0.75rem' }}>
                      ...
                      {!imagesFile && <input type="url" value={imagesUrl} onChange={e => setImagesUrl(e.target.value)} style={{ width: '100%', padding: '0.5rem 0.6rem', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--glass-border)', borderRadius: '10px', color: 'var(--foreground)' }} placeholder="Or paste URL here: https://imgur.com/..." />}
                    </div>
                    <div style={{ flex: 1, minWidth: '200px' }}>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.2rem', color: 'var(--text-muted)', fontSize: '0.75rem' }}>
                      ...
                      {!videoFile && <input type="url" value={videoUrl} onChange={e => setVideoUrl(e.target.value)} style={{ width: '100%', padding: '0.5rem 0.6rem', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--glass-border)', borderRadius: '10px', color: 'var(--foreground)' }} placeholder="Or paste URL here: https://youtube.com/..." />}
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
                  ...
                  <button type="submit" disabled={isUploading} style={{ flex: 1, padding: '0.5rem 0.6rem', background: '#55bb55', border: 'none', color: '#fff', borderRadius: '10px', fontWeight: 600, cursor: isUploading ? 'not-allowed' : 'pointer', opacity: isUploading ? 0.7 : 1 }}>
