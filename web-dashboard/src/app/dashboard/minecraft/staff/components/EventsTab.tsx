            ...
            >
              ...
              <form onSubmit={handleSubmitReport} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                  <div style={{ flex: 1 }}>
                    <label style={{ display: 'block', marginBottom: '0.5rem', color: 'var(--text-muted)', fontSize: '0.9rem' }}>Attendance Medium</label>
                    <CustomSelect 
                ...
                <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
                  ...
                  <button type="submit" style={{ flex: 1, padding: '0.8rem', background: '#55bb55', border: 'none', color: '#fff', borderRadius: '10px', fontWeight: 600, cursor: 'pointer' }}>Submit Report</button>
                </div>
              </form>
            </motion.div>
          </div>
        ...
        {showAddModal && (
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(5px)', zIndex: 100, display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '1rem' }}>
            <motion.div 
              ...
              style={{ background: 'var(--background)', border: '1px solid var(--glass-border)', borderRadius: '20px', width: '100%', maxWidth: '550px', padding: '2rem', maxHeight: '90vh', overflowY: 'auto' }}
            >
              <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--foreground)', marginBottom: '1.5rem' }}>{editingEvent ? 'Edit Minecraft Event' : 'Create Minecraft Event'}</h2>
              <form onSubmit={handleCreateEvent} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div>
                  ...
                  <input type="text" required value={title} onChange={e => setTitle(e.target.value)} style={{ width: '100%', padding: '0.8rem', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--glass-border)', borderRadius: '10px', color: 'var(--foreground)' }} placeholder="e.g. Building Contest" />
                </div>
                <div>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <CustomSelect 
                      ...
                      options={[
                        { value: 'text', label: 'Text (15 pts - 1 supervisor)' },
                ...
                <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
                  ...
                  <button type="submit" style={{ flex: 1, padding: '0.8rem', background: '#55bb55', border: 'none', color: '#fff', borderRadius: '10px', fontWeight: 600, cursor: 'pointer' }}>{editingEvent ? 'Save Changes' : 'Create Event'}</button>
                </div>
              </form>
            </motion.div>
          </div>
