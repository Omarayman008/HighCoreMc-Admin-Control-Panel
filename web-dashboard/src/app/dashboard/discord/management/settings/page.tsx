...
const DEFAULT_ADMIN_ROLES = [
  { id: '1337490826326048922', name: 'OP STAFF', color: '#ff0000', priority: 1, enabled: true },
  { id: '1489671552730402909', name: 'Secret Team', color: '#9b59b6', priority: 2, enabled: true },
  { id: '1487152572207861870', name: 'Opex Founder', color: '#ff0000', priority: 3, enabled: true },
  { id: '1487152882074521771', name: 'Opex Manager', color: '#ff4400', priority: 4, enabled: true },
  { id: '1487152873048641677', name: 'Opex Developer', color: '#ff8800', priority: 5, enabled: true },
  { id: '1487152641028128979', name: 'Opex Investors', color: '#e67e22', priority: 6, enabled: true },
  { id: '1487152897773797637', name: 'Department Manager', color: '#f1c40f', priority: 7, enabled: true },
  { id: '1487152904824422521', name: 'DC Leader', color: '#2ecc71', priority: 8, enabled: true },
  { id: '1487152907848646787', name: 'Moderator', color: '#27ae60', priority: 9, enabled: true },
  { id: '1487152911472394401', name: 'Helper', color: '#1abc9c', priority: 10, enabled: true },
  { id: '1487152913422749980', name: 'Guardian', color: '#00ccff', priority: 11, enabled: true },
  { id: '1487152917763981574', name: 'DC Department', color: '#3498db', priority: 12, enabled: true },
  { id: '1487152923824885860', name: 'MC Leader', color: '#2ecc71', priority: 13, enabled: true },
  { id: '1487152926827876462', name: 'Reference', color: '#00ccff', priority: 14, enabled: true },
  { id: '1487195243391614997', name: 'Ancient', color: '#00ccff', priority: 15, enabled: true },
  { id: '1487195244230475958', name: 'Supreme', color: '#00ff00', priority: 16, enabled: true },
  { id: '1487195245509742682', name: 'Vanguard', color: '#3498db', priority: 17, enabled: true },
  { id: '1487195246608646275', name: 'MC Department', color: '#3498db', priority: 18, enabled: true },
  { id: '1487195247430602852', name: 'Hype Manager', color: '#e91e63', priority: 19, enabled: true },
  { id: '1487195248059879555', name: 'Hype Events', color: '#9b59b6', priority: 20, enabled: true },
  { id: '1487230361543901224', name: 'Hype Media', color: '#ff00ff', priority: 21, enabled: true },
  { id: '1487230245487644712', name: 'Hype Department', color: '#9b59b6', priority: 22, enabled: true },
  { id: '1487195816220430406', name: 'Staff', color: '#3498db', priority: 23, enabled: true },
  { id: '1487195249817423902', name: 'Trial Staff', color: '#95a5a6', priority: 24, enabled: true }
];
